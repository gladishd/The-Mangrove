...
export default class SignupPolitician extends React.Component {
  ...
  render() {
    return (
      <div style={{ fontSize: '1.5em', backgroundColor: 'rgb(250,250,250)', width: '100vw', height: '100vh', position: 'absolute' }}>
          ...
          <div >
            ...
            >
              ...
              <Form.Group className="mb-3" controlId="formMiddleInitial">
                ...
                <Form.Control type="middleInitial" placeholder="Middle Initial" />
              </Form.Group>
