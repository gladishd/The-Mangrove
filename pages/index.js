...
export default function Home() {
  return (
    <div className="container">
      <Head>
        <title>Two Signup Types, and the Users {`&`} Politicians </title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main>
        <h1 className="title">
          Greetings to the politicians, thanks to <a href="https://nextjs.org">Next.js.org!</a>
        </h1>

        <p className="description" style={{ fontSize: '1em' }}>
          For users we have two basic tabs... login and <code>...pages/signup.js</code>.
          And the complex verification system made possible by our sponsor Next JS.
        </p>

        <div className="grid">
          <a href="https://nextjs.org/docs" className="card">
            <h3>An Explore tab with Signup &rarr;</h3>
            <p>Find in-depth information about discovering new people, and generate a follow tab for updates on people you've followed.</p>
          </a>
