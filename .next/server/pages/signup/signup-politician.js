...
/* harmony export */   "default": () => (/* binding */ SignupPolitician)
/* harmony export */ });
...
/* harmony import */ var react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(8582);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([firebase_compat_app__WEBPACK_IMPORTED_MODULE_2__, firebase_compat_auth__WEBPACK_IMPORTED_MODULE_3__, firebase_compat_firestore__WEBPACK_IMPORTED_MODULE_4__]);
...
class SignupPolitician extends (react__WEBPACK_IMPORTED_MODULE_9___default().Component) {
    constructor(props){
        super(props);
        this.state = {};
    ...
    async submitForm(e) {
        ...
        let formFirstName = e.target.elements.formFirstName.value;
        let formMiddleInitial = e.target.elements.formMiddleInitial.value;
        let formLastName = e.target.elements.formLastName.value;
        // let City = e.target.elements.City.value
        let formBasicCheckbox = e.target.elements.formBasicCheckbox.value;
        await axios__WEBPACK_IMPORTED_MODULE_10___default().post("/api/signup", {
            formBasicEmail,
            formBasicPassword,
        ...
        try {
            let response = await axios__WEBPACK_IMPORTED_MODULE_10___default().post("/api/sessions", {
                user: {
            ...
            response = await axios__WEBPACK_IMPORTED_MODULE_10___default().post("/api/userDatabase", {
            ...
            firebaseApp.auth().createUserWithEmailAndPassword(formBasicEmail, formBasicPassword).then(async (response)=>{
                firebase_compat_app__WEBPACK_IMPORTED_MODULE_2__["default"].auth().signInWithEmailAndPassword(formBasicEmail, formBasicPassword).then(async (response)=>{
                    ...
                    new (sweetalert2__WEBPACK_IMPORTED_MODULE_1___default())({
                        title: "Hold On!",
                        text: e,
                        icon: "warning",
                        button: "OK"
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_6___default().Group), {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_6___default().Text), {
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((react_bootstrap_DropdownButton__WEBPACK_IMPORTED_MODULE_7___default()), {
                                id: "dropdown-basic-button",
                                title: "(Title)",
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_8___default().Item), {
                                        href: "#/action-1",
                                        children: "Action"
                                    }),
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Dropdown__WEBPACK_IMPORTED_MODULE_8___default().Item), {
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_6___default().Group), {
                                className: "mb-3",
                                controlId: "formBasicCheckbox",
                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_6___default().Check), {
                                    type: "checkbox"
                                })
                            }),
                            "Are you in office or running for Office?",
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_bootstrap_Form__WEBPACK_IMPORTED_MODULE_6___default()), {
                                children: [
                                    "radio"
                                ].map((type)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        className: "mb-3",
                                        children: [
...
var __webpack_exports__ = (__webpack_exec__(4338));
